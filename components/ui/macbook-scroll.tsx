...
export const MacbookScroll = ({
  ...
  return (
    ...
    <div
      ref={ref}
      className="min-h-[300vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 bg-black "
    ...
    >
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-gray-800 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
